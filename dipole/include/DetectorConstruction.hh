...
private:
  ...
  void ConstructTarget(G4LogicalVolume* logicWorld);
  ...
  void ConstructDipoleA(G4LogicalVolume* logicWorld);
  void ConstructDipoleB(G4LogicalVolume* logicWorld);
  void ConstructDipoleC(G4LogicalVolume* logicWorld);
